  ...
  return (
    <div className="FeedBack taped sticker-box green">
      ...
      <div className={`question ${errors.q1 ? "error" : ""}`}>
        ...
        <div className="rating">
          {[1, 2, 3, 4, 5].map(value => (
            <button
              key={value}
              className={`rating-button ${answers.q1 === value ? "active" : Number(answers.q1) > value ? "color" : ""}`}
      ...
      <div className={`question ${errors.q3 ? "error" : ""}`}>
        ...
        <div className="rating">
          {[1, 2, 3, 4, 5].map(value => (
            <button
              key={value}
              className={`rating-button ${answers.q3 === value ? "active" : Number(answers.q3) > value ? "color" : ""}`}
      ...
      <div className={`question ${errors.q5 ? "error" : ""}`}>
        ...
        <div className="rating">
          {[1, 2, 3, 4, 5].map(value => (
            <button
              key={value}
              className={`rating-button ${answers.q5 === value ? "active" : Number(answers.q5) > value ? "color" : ""}`}
      ...
      <div className="question">
        <h2>
          <TextWithRuby text={"Q4 : このサイトに関する感想・意見を自由にお寄せください"} anotherRuby={{ 関: "かん" }} />
        </h2>
        <textarea value={answers.q7} onChange={e => setAnswers(prev => ({ ...prev, q7: e.target.value }))} />
      </div>

      {/* Submit */}
      <button className="husen" style={{ margin: "0 auto" }} onClick={() => handleSubmit()}>
