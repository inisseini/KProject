...
const ResearchSupport = () => {
  return (
    <div className='research-support taped'>
      ...
      <div className='steps'>
        <h2
          className='sub-title husen pointer-less'
        ...
        <ol>
          <li>
            <TextWithRuby
              text={'・研究のタイトル : 自由研究のタイトルだよ！'}
            />
          </li>
          <li>
            <TextWithRuby
              text={'・研究のきっかけ : どうして興味を持ったんだっけ？'}
            />
          </li>
          <li>
            <TextWithRuby
              text={'・予想 : 研究は予想が大事！外れても大丈夫！'}
            />
          </li>
          <li>
            <TextWithRuby
          ...
          <li>
            <TextWithRuby
              text={'・感想 : 研究は面白かったかな？自由な感想を書いてみよう！'}
            />
          </li>
          <li>
            <TextWithRuby
              text={
                '・参考にしたもの : URLや書籍など参考にしたものがあれば書こう！'
              }
            />
          </li>
        </ol>
      ...
      <div className='download'>
        <h2
          className='sub-title husen green pointer-less'
          style={{ margin: '20px auto' }}
        >
        ...
        <p>
          <TextWithRuby
            text={'下記のリンクからPDFファイルをダウンロードできます。'}
          />
        </p>
