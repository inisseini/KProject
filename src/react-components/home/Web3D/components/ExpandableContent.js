...
const ExpandableContent = ({ selectedNum }) => {
        ...
        <div
          ...
          onClick={() =>
            (window.location.href =
              'https://www.gsi.go.jp/KIDS/KIDS05_00002.html')
          }
        >
    ...
    4: (
      <>
        ...
        <div
          ...
          onClick={() =>
            (window.location.href =
              'http://www.nikkeishin.or.jp/img/kinenbi_img/No56-1.pdf')
          }
        >
          <TextWithRuby text={'詳細はこちら'} />
          <span></span>
    ...
    9: (
      <>
        ...
        <div
          ...
          style={{ margin: '30px auto' }}
          onClick={() =>
            (window.location.href = 'https://www.env.go.jp/air/ippan/')
          }
        >
          <TextWithRuby text={'詳細はこちら'} />
          <span></span>
