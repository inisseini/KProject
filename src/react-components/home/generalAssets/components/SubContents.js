  ...
  return (
    <div style={{ position: 'relative', zIndex: '2' }} className='subContainer'>
      <div className='menuContainer fm'>
        <div
          className='husen animatedItem horizon fs'
        ...
        <div className='forUser'>
          <div
            ...
            onClick={() => handleNavigate('#WhyAnchor')}
          >
          ...
          <div
            className='husen animatedItem horizon'
            onClick={() => handleNavigate('#AboutAnchor')}
          >
          ...
          <div
            className='husen animatedItem horizon'
            onClick={() => handleNavigate('#HowAnchor')}
          >
          ...
          <div
            className='husen animatedItem horizon'
            onClick={() => handleNavigate('#ResearchAnchor')}
          >
          ...
          <div
            ...
            onClick={() => handleNavigate('#forParentsAnchor')}
          >
          ...
          <div
            className='husen green animatedItem horizon'
            onClick={() => handleControlsClickLink()}
          >
      ...
      <div
        ...
        onClick={() => handleControlsClickContact()}
      >
        <IoMdMail />
        <CustomModal
          triggerText='お問い合わせはこちら'
          triggerRef={triggerRefContact}
        >
          <ContactForm />
          <IoMdMail />
        </CustomModal>
