...
const TopPage = (props) => {
  ...
  const [isPassed, setIsPassed] = useState(
    JSON.parse(localStorage.getItem('quizPassed')) || false
  );
      ...
      <div className='TopPage'>
        ...
        <div className='section section1' id='TopAnchor'>
            ...
            {isPassed ? (
              <div className='item4'>
                ...
                <a
                  href={ninnteijou}
                  download
                  className='husen animatedItem horizon PC'
                >
              ...
              <img
                src={Goal}
                alt='ロゴ'
                className='HakaseGoal item4 animatedItem vertical PC'
              />
            )}
          ...
          <div className='contentsContainer fm'>
                ...
                <div className='marker-box concept'>
                  ...
                  >
                    ...
                    >
                      <img
                        src={hakarun}
                        alt='はかるん'
                        style={{ width: '150px', maxWidth: '25dvw' }}
                      />
                      <TextWithRuby
                        text={'東京都計量検定所\n公式キャラクター「はかるん」'}
                      />
                  ...
                  <div className='topImgContainer'>
                    <img
                      src={topImg1}
                      alt='topImg'
                      className='animatedItem vertical'
                      style={{ zIndex: '-110' }}
                    />
                    <img
                      src={topImg2}
            ...
            <div className='forUser fm'>
              <div
                className='husen animatedItem horizon'
                onClick={() => scrollToSectionTop('WhyAnchor')}
              >
              ...
              <div
                className='husen animatedItem horizon'
                onClick={() => scrollToSectionTop('AboutAnchor')}
              >
              ...
              <div
                className='husen animatedItem horizon'
                onClick={() => scrollToSectionTop('HowAnchor')}
              >
              ...
              <div
                className='husen animatedItem horizon'
                onClick={() => scrollToSectionTop('ResearchAnchor')}
              >
                <TextWithRuby text={'自由研究におすすめ！'} /> <span></span>
              </div>
              <div
                className='husen animatedItem horizon'
                onClick={() => scrollToSectionTop('FAQ')}
              >
                サービスの利用について <span></span>
              </div>
              <div
                className='husen green animatedItem horizon'
                onClick={() => scrollToSectionTop('forParentsAnchor')}
              >
        ...
        <div className='section'>
          <div className='Reseach text'>
            ...
            <div
              className='ResearchContainer fm'
