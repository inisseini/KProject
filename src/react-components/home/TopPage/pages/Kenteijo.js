...
const Kenteijo = () => {
  ...
  const faqs = [
    ...
    {
      question: (
        <TextWithRuby text={'子供向けにやっているイベントがあったら教えて！'} />
      ),
      answer: (
        <>
          <TextWithRuby
      ...
      answer: (
        <>
          ...
          <div
            ...
            onClick={() =>
              (window.location.href =
                'https://www.shouhiseikatu.metro.tokyo.lg.jp/keiryo/work/keiryotennjisitu.html')
            }
          >
            <TextWithRuby text={'詳細はこちら'} />
            <span></span>
      ...
      answer: (
        <div>
          ...
          <div
            ...
            onClick={() =>
              (window.location.href =
                'https://www.instagram.com/tokyoartsandculture/')
            }
          >
            <TextWithRuby text={'詳細'} />
            <span></span>
