...
const ContactForm = () => {
  ...
  const sendEmail = async () => {
    ...
    xhr.open(
      'POST',
      'https://qlbnadimyn6wyplzguyqrwleia0psudo.lambda-url.ap-northeast-1.on.aws/',
      true
    );
      ...
      <div style={styles.field}>
        ...
        <input
          ...
          style={{
            ...styles.input,
            borderColor:
              formData.email === formData.confirmEmail ? '#ccc' : 'red',
          }}
          required
        />
      </div>
            ...
            >
              {inquiryTypes.map((type) => (
                <li
                  key={type.value}
                  onClick={() =>
                    handleDropdownSelect('inquiryType', type.value)
                  }
                  style={{
                    padding: '10px',
                    borderBottom: '1px solid #eee',
